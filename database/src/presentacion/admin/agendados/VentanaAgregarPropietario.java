...
public class VentanaAgregarPropietario extends javax.swing.JFrame {

    public VentanaAgregarPropietario() {
        initComponents();
        start();
    }
...
//        this.setIconImage(new ImageIcon(getClass().getResource("../imagenes/HouseLogo.png")).getImage());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Datos Domicilio");

        jLabel5.setText("Datos Telefonicos");

        jLabel6.setText("Otros Datos");

        jLabel7.setText("Datos Internet");
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "D.N.I", "L.E", "L.C", "PAS." }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // aca se guarda en la base de datos cada wuaso agendado..        
        dispose();
